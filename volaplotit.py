...
df = pd.read_csv(r'C:\Users\q8606\Desktop\GRADUTUTKIMUKSET\FTSE100.csv', sep=";",index_col='Name', parse_dates=True, dayfirst=True)
...
df["5dvol"] = df["indeksi"].pct_change().rolling(window_size5d).std()*(252**0.5)
